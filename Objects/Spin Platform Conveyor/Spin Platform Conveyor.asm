...
loc_16456:
		...
		move.w	(a1,d1.w),scon_saveX(a0)
		move.w	2(a1,d1.w),scon_saveY(a0)
		tst.w	d1
		bne.s	loc_16474
		move.b	#1,anim(a0)
...
; ---------------------------------------------------------------------------
		...
		include "Objects/Spin Platform Conveyor/Object Data/Data - Spin Platform Conveyor.asm"
		include "Objects/Spin Platform Conveyor/Object Data/Anim - Spin Platform Conveyor.asm"

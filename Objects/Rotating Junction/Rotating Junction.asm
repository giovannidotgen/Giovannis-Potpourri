...
jun_save			= objoff_32	; save frame						; .b
jun_frame		= objoff_34	; add or sub frame					; .b
jun_reverse		= objoff_36	; flag set when switch is pressed		; .b
jun_switch		= objoff_38	; which switch will reverse the disc	; .b
jun_status		= objoff_39	; status							; .b

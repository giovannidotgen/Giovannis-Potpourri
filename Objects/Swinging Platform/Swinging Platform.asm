...
swing_origX				= objoff_42 ; original x-axis position
swing_origY				= objoff_44 ; original y-axis position
...
; ---------------------------------------------------------------------------
		...
		include "Objects/Swinging Platform/Object Data/Map - Swinging Platforms(GHZ).asm"
		include "Objects/Swinging Platform/Object Data/Map - Swinging Platforms(SLZ).asm"
		include "Objects/Swinging Platform/Object Data/Map - Swinging Platforms(SBZ).asm"

...
; ---------------------------------------------------------------------------
		...
		include "Objects/Vanishing Platforms/Object Data/Anim - Vanishing Platforms.asm"
		include "Objects/Vanishing Platforms/Object Data/Map - Vanishing Platforms.asm"

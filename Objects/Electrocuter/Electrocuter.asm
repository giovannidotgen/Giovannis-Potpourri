...
; mapping
ObjDat_Electro:	subObjData Map_Elec, $529, 0, 0, 32, 80, 1, 0, $24|$80
; ---------------------------------------------------------------------------

		include "Objects/Electrocuter/Object Data/Anim - Electrocuter.asm"
		include "Objects/Electrocuter/Object Data/Map - Electrocuter.asm"

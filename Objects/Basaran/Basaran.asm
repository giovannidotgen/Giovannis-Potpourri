...
; mapping
ObjDat_Basaran:		subObjData Map_Bas, $529, 0, 1, 24, 32, 2, 0, $B
; ---------------------------------------------------------------------------

		include "Objects/Basaran/Object Data/Anim - Basaran.asm"
		include "Objects/Basaran/Object Data/Map - Basaran.asm"

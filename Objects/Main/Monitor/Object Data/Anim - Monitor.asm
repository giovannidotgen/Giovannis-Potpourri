...
Ani_Monitor: offsetTable
		...
		offsetTableEntry.w byte_1DB54		; 1 (1UP)
		...
		offsetTableEntry.w byte_1DB9C		; A (Blue)
		offsetTableEntry.w byte_1DBA4		; B (Break)
...
byte_1DB9C:		dc.b 1, 0, $B, $B, 1, $B, $B, afEnd
byte_1DBA4:		dc.b 2, 0, 1, $C, afBack, 1
	even
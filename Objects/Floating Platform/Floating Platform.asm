...
; ---------------------------------------------------------------------------
		...
		include "Objects/Floating Platform/Object Data/Map - Floating Platform(SYZ).asm"
		include "Objects/Floating Platform/Object Data/Map - Floating Platform(SLZ).asm"

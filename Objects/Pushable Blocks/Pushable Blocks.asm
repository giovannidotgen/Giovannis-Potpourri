...
pushb_origXvel				= objoff_30	; .w
pushb_floatflag				= objoff_32	; .b
pushb_sound					= objoff_33	; .b
pushb_origX					= objoff_34	; .w	; original x-axis position
pushb_origY					= objoff_36	; .w	; original y-axis position
pushb_p1					= objoff_3A	; .b
pushb_p2					= objoff_3B	; .b
pushb_jump					= objoff_3C	; .l

; =============== S U B R O U T I N E =======================================

PushableBlock_Var:
		dc.b 32/2, 0	; object width, frame number
		dc.b 128/2, 1
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
		...
		include "Objects/Pushable Blocks/Object Data/Map - Pushable Blocks.asm"

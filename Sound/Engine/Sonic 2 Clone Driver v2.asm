...
PlayCD_Index:
	...
	dc.l _MCD_PlayTrack<<24|$00000000			; $02 (MZ)
	dc.l _MCD_PlayTrack<<24|$00000000			; $03 (SYZ)
	dc.l _MCD_PlayTrack<<24|$00000000			; $04 (LZ)
	dc.l _MCD_PlayTrack<<24|$00000000			; $05 (SLZ)
	...
	dc.l _MCD_PlayTrack<<24|$00000000			; $0B (Menu)
	dc.l _MCD_PlayTrack_Once<<24|$00000000	; $0C (Ending)

	; Bosses
	dc.l _MCD_PlayTrack<<24|$00000000			; $0D (S1 Boss)
	dc.l _MCD_PlayTrack<<24|$00000000			; $0E (FZ)
	dc.l _MCD_PlayTrack<<24|$00000000			; $0F (Mid Boss)
	dc.l _MCD_PlayTrack<<24|$00000000			; $10 (Boss)
	dc.l _MCD_PlayTrack<<24|$00000000			; $11 (Final Boss)

	; End
	dc.l _MCD_PlayTrack_Once<<24|$00000000	; $12 (Act Clear)
	dc.l _MCD_PlayTrack_Once<<24|$00000000	; $13 (Game Over)
	dc.l _MCD_PlayTrack<<24|$00000000			; $14 (Continue)
	dc.l _MCD_PlayTrack<<24|$00000000			; $15 (S3 Credits)
	dc.l _MCD_PlayTrack_Once<<24|$00000000	; $16 (Countdown)
	dc.l _MCD_PlayTrack_Once<<24|$00000000	; $17 (Emerald)

	; Extra
	dc.l _MCD_PlayTrack<<24|$00000000			; $18 (Speedup)
	even

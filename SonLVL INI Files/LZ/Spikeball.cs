...
namespace S3KObjectDefinitions.LZ
{
	class Spikeball : ObjectDefinition
	{
		...
		{
			byte[] artfile = ObjectHelper.OpenArtFile("../Objects/Spiked Ball and Chain/KosinskiPM Art/Spiked Ball and Chain.kospm", CompressionType.KosinskiPlusM);
			img = ObjectHelper.MapASMToBmp(artfile, "../Objects/Spiked Ball and Chain/Object Data/Map - Spiked Ball and Chain (LZ).asm", 1, 0);
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(artfile, "../Objects/Spiked Ball and Chain/Object Data/Map - Spiked Ball and Chain (LZ).asm", labels[i], 0));
		}

...
namespace S3KObjectDefinitions.MZ
{
	class SidewaysStomper : ObjectDefinition
	{
		...
		{
			byte[] blocks = ObjectHelper.OpenArtFile("../Objects/Chained Stompers/KosinskiPM Art/Metal Blocks.kospm", CompressionType.KosinskiPlusM);
			byte[] padding = new byte[0x4360-blocks.Length];
			byte[] spikes = ObjectHelper.OpenArtFile("../Objects/Spikes/KosinskiPM Art/SpikesSprings.kospm", CompressionType.KosinskiPlusM);
			...
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(artfile, "../Objects/Chained Stompers/Object Data/Map - Sideways Stomp.asm", labels[i], 0));
		}

	...
	class Monitor : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			indexer.AddFile(new List<byte>(LevelData.ReadFile(
				"../Objects/Monitor/KosinskiPM Art/Monitors.kospm", CompressionType.KosinskiPlusM)), 0);
			indexer.AddFile(new List<byte>(LevelData.ReadFile(
				"../Objects/HUD/KosinskiPM Art/Sonic Life Icon.kospm", CompressionType.KosinskiPlusM)), 25856);

			var art = indexer.ToArray();
			var map = LevelData.ASMToBin(
				"../Objects/Monitor/Object Data/Map - Monitor.asm", LevelData.Game.MappingsVersion);

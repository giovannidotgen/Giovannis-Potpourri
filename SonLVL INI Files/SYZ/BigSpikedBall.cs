...
namespace S3KObjectDefinitions.SYZ
{
	class BigSpikedBall : ObjectDefinition
	{
		...
		{
			img = (ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Objects/Big Spiked Ball/KosinskiPM Art/Large Spikeball.kospm", CompressionType.KosinskiPlusM), "../Objects/Big Spiked Ball/Object Data/Map - Big Spiked Ball.asm", 0, 0));
		}

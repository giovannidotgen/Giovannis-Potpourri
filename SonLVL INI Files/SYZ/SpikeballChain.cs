...
namespace S3KObjectDefinitions.SYZ
{
	class SpikeballChain : ObjectDefinition
	{
		...
		{
			img = ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Objects/Spiked Ball and Chain/KosinskiPM Art/Small Spikeball.kospm", CompressionType.KosinskiPlusM), "SYZ/Mappings/Map - Spiked Ball and Chain (SYZ).asm", "Map_SBall", 0);
		}

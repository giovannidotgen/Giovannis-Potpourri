...
namespace S3KObjectDefinitions.SBZ
{
	class Flamethrower : ObjectDefinition
	{
		...
		{
			byte[] artfile = ObjectHelper.OpenArtFile("../Objects/Flamethrower/KosinskiPM Art/Flaming Pipe.kospm", CompressionType.KosinskiPlusM);
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(artfile, "../Objects/Flamethrower/Object Data/Map - Flamethrower.asm", labels[i], 0));
		}

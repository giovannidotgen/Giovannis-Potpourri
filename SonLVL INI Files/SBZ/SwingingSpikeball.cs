	...
	class SwingingSpikeball : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Objects/Big Spiked Ball/KosinskiPM Art/Large Spikeball.kospm", CompressionType.KosinskiPlusM), "../Objects/Big Spiked Ball/Object Data/Map - Big Spiked Ball.asm", labels[i], i == 2 ? 2 : 0));
		}

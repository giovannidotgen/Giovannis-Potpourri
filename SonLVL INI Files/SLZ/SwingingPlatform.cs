...
namespace S3KObjectDefinitions.SLZ
{
	class SwingingPlatform : ObjectDefinition
	{
		...
		{
			imgwreckingball = ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Objects/Swinging Platform/KosinskiPM Art/SLZ Swinging Platform.kospm", CompressionType.KosinskiPlusM), "../Objects/Swinging Platform/Object Data/Map - Swinging Platforms(SLZ).asm", 1, 2);
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Objects/Swinging Platform/KosinskiPM Art/SLZ Swinging Platform.kospm", CompressionType.KosinskiPlusM), "../Objects/Swinging Platform/Object Data/Map - Swinging Platforms(SLZ).asm", labels[i], i == 1 ? 2 : 2));
		}

...
namespace S3KObjectDefinitions.SLZ
{
	class Block : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			img = ObjectHelper.MapASMToBmp(artfile, "../Objects/Floating Blocks and Doors/Object Data/Map - Floating Blocks and Doors.asm", 0, 2);
			for (int i = 0; i < 8; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(artfile, "../Objects/Floating Blocks and Doors/Object Data/Map - Floating Blocks and Doors.asm", i, 2));
		}

...
namespace S3KObjectDefinitions.GHZ
{
	class Bridge : ObjectDefinition
	{
		...
		{
			byte[] artfile = ObjectHelper.OpenArtFile("../Objects/Bridge/KosinskiPM Art/Bridge.kospm", CompressionType.KosinskiPlusM);
			img = ObjectHelper.MapASMToBmp(artfile, "../Objects/Bridge/Object Data/Map - Tension Bridge.asm", 0, 2);
		}

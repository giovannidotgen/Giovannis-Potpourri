...
namespace S3KObjectDefinitions.GHZ
{
	class SwingingPlatform : ObjectDefinition
	{
		...
		{
			imgwreckingball = ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Objects/Swinging Platform/KosinskiPM Art/GHZ Swinging Platform.kospm", CompressionType.KosinskiPlusM), "../Objects/Swinging Platform/Object Data/Map - Swinging Platforms(GHZ).asm", 1, 2);
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Objects/Swinging Platform/KosinskiPM Art/GHZ Swinging Platform.kospm", CompressionType.KosinskiPlusM), "../Objects/Swinging Platform/Object Data/Map - Swinging Platforms(GHZ).asm", labels[i], i == 1 ? 0 : 0));
		}

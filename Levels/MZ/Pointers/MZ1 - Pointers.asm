; ---------------------------------------------------------------------------
; MZ1 level pointer data
; ---------------------------------------------------------------------------

		; Level init
		dc.l MZ1_Resize								; Resize
		dc.l 0										; Water resize
		dc.l 0										; After boss
		...
		binclude "Levels/MZ/Start Location/Sonic/1.bin"
		binclude "Levels/MZ/Start Location/Knuckles/1.bin"

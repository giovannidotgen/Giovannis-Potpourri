...
"%AS_MSGPATH%\p2bin.exe" -p=FF -z=0,kosinskiplus,Size_of_Snd_driver_guess,after S1S3.p S1S3.gen S1S3.h
IF ERRORLEVEL 1 (
...
"%AS_MSGPATH%\convsym.exe" S1S3.lst "Engine\_RAM.lst" -in as_lst -out asm -range FF0000 FFFFFF
IF ERRORLEVEL 1 (
